...
* [Repositorio con ejemplo de uso combinado de Express y Sequelize](https://github.com/SYTW/express-example)
* Material del Curso de MiriadaX "Desarrollo de servicios en la nube con HTML5, Javascript y node.js"
  * La Base de Datos, Sequelize, Heroku, Autoload
    * [Trasparencias: La Base de Datos, Sequelize, Heroku, Autoload](apuntes/db/sequelize/transp_modulo7.pdf)
